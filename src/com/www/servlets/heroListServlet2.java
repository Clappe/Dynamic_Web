...
@WebServlet(name = "heroListServlet2")
public class heroListServlet2 extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String format = "<tr><td>%d</td><td>%s</td><td>%f</td><td>%d</td><td><a href='editHero?id=%d'>edit</a></td>" +
                "<td><a href='deleteHero?id=%d'>delete</a></td></tr>\r\n";

        for (Hero hero : heroes
              ) {
            String string = String.format(format, hero.getId(), hero.getName(), hero.getHp(), hero.getDamage(), hero.getId(), hero.getId());
